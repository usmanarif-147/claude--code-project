<div>
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-white">{{ $skill ? 'Edit Skill' : 'Create Skill' }}</h1>
        ...
        <div class="bg-dark-800 border border-dark-700 rounded-xl p-6 space-y-5">
            ...
            <div>
                ...
                <textarea id="icon" wire:model="icon" rows="3"
                          class="w-full bg-dark-700 border border-dark-600 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:ring-2 focus:ring-accent-500 focus:border-transparent font-mono text-sm"
                ...
                @if ($icon)
                    <div class="mt-3 p-4 bg-dark-700 rounded-lg">
                        ...
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" class="w-8 h-8 text-accent-400">
                            {!! $icon !!}
                        </svg>
                    </div>
                @endif
