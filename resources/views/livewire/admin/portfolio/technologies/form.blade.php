<div>
    <div class="flex items-center gap-2 text-xs text-gray-500 mb-2">
        ...
        <a href="{{ route('admin.technologies.index') }}" wire:navigate class="hover:text-gray-300 transition-colors">Technologies</a>
        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        <span class="text-gray-300">{{ $technology ? 'Edit' : 'Create' }} Technology</span>
    </div>
    ...
    <form wire:submit="save" class="max-w-2xl">
        <div class="bg-dark-800 border border-dark-700 rounded-xl p-6 space-y-5">
            ...
            <div>
                <label for="category" class="block text-sm font-medium text-gray-300 mb-1.5">Category <span class="text-red-400">*</span></label>
