<div>
    <div class="flex items-center gap-2 text-xs text-gray-500 mb-2">
        ...
        <a href="{{ route('admin.testimonials.index') }}" wire:navigate class="hover:text-gray-300 transition-colors">Testimonials</a>
        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        <span class="text-gray-300">{{ $testimonial ? 'Edit' : 'Create' }} Testimonial</span>
    </div>
    ...
    <form wire:submit="save" class="max-w-3xl space-y-6">
        <div class="bg-dark-800 border border-dark-700 rounded-xl p-6 space-y-5">
            ...
            <div>
                <label for="client_name" class="block text-sm font-medium text-gray-300 mb-1.5">Client Name <span class="text-red-400">*</span></label>
            ...
            {{-- Client Photo --}}
            <div>
                <label class="block text-sm font-medium text-gray-300 mb-1.5">Client Photo</label>
            ...
            <div>
                <label for="review" class="block text-sm font-medium text-gray-300 mb-1.5">Review <span class="text-red-400">*</span></label>
            ...
            <div>
                <label for="project_url" class="block text-sm font-medium text-gray-300 mb-1.5">Project URL</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    <label for="received_at" class="block text-sm font-medium text-gray-300 mb-1.5">Received At</label>
