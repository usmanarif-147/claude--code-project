                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @if(!$idea->content_calendar_item_id)
                                        <button wire:click="moveToCalendar({{ $idea->id }})" wire:confirm="Move this idea to the content calendar?"
                                    ...
                                    @endif
                                    <button wire:click="delete({{ $idea->id }})" wire:confirm="Are you sure you want to delete this video idea?"
