        ...
        <nav class="flex-1 px-4 py-6 space-y-1">
            ...
            <div x-data="{ homeOpen: {{ $homeActive ? 'true' : 'false' }} }">
                <button @click="homeOpen = !homeOpen"
                    ...
                    Home
                    <svg class="w-4 h-4 ml-auto transition-transform duration-200" :class="homeOpen ? 'rotate-90' : ''"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </button>

                <div x-show="homeOpen" x-transition:enter="transition ease-out duration-200"
            ...
            <div x-data="{ portfolioOpen: {{ $portfolioActive ? 'true' : 'false' }} }">
                ...
                <div x-show="portfolioOpen" x-transition:enter="transition ease-out duration-200"
                    ...
                    <a href="{{ route('admin.resume') }}"
                        class="flex items-center gap-3 pl-10 pr-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('admin.resume') || request()->routeIs('admin.resume.*') ? 'bg-primary/10 text-primary-light' : 'text-gray-400 hover:text-white hover:bg-dark-700' }} transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div x-data="{ jobSearchOpen: {{ $jobSearchActive ? 'true' : 'false' }} }">
                <button @click="jobSearchOpen = !jobSearchOpen"
                    ...
                    Job Search
                    <svg class="w-4 h-4 ml-auto transition-transform duration-200"
                        :class="jobSearchOpen ? 'rotate-90' : ''" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </button>

                <div x-show="jobSearchOpen" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 -translate-y-1"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-150"
                    x-transition:leave-start="opacity-100 translate-y-0"
            ...
            <div x-data="{ emailOpen: {{ $emailActive ? 'true' : 'false' }} }">
                <button @click="emailOpen = !emailOpen"
                    ...
                    Email
                    <svg class="w-4 h-4 ml-auto transition-transform duration-200"
                        :class="emailOpen ? 'rotate-90' : ''" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </button>

                <div x-show="emailOpen" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 -translate-y-1"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-150"
                    x-transition:leave-start="opacity-100 translate-y-0"
            ...
            <div x-data="{ aiAssistantOpen: {{ $aiAssistantActive ? 'true' : 'false' }} }">
                <button @click="aiAssistantOpen = !aiAssistantOpen"
                    ...
                    AI Assistant
                    <svg class="w-4 h-4 ml-auto transition-transform duration-200"
                        :class="aiAssistantOpen ? 'rotate-90' : ''" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </button>

                <div x-show="aiAssistantOpen" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 -translate-y-1"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-150"
                    x-transition:leave-start="opacity-100 translate-y-0"
